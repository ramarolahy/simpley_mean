...
/* harmony import */ var _components_today_today_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/today/today.component */ "./src/app/components/today/today.component.ts");
...
/* harmony import */ var _components_task_list_task_list_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./components/task-list/task-list.component */ "./src/app/components/task-list/task-list.component.ts");
/* harmony import */ var _components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/add-task/add-task.component */ "./src/app/components/add-task/add-task.component.ts");
...
/* harmony import */ var _services_auth_authentication_service__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./services/auth/authentication.service */ "./src/app/services/auth/authentication.service.ts");
/* harmony import */ var _services_auth_authenticate_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./services/auth/authenticate.service */ "./src/app/services/auth/authenticate.service.ts");
/* harmony import */ var _services_today_today_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/today/today.service */ "./src/app/services/today/today.service.ts");
...
var routes = [
    ...
    { path: 'today', component: _components_today_today_component__WEBPACK_IMPORTED_MODULE_11__["TodayComponent"], canActivate: [_services_auth_authenticate_service__WEBPACK_IMPORTED_MODULE_17__["AuthenticateService"]] }
];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_today_today_component__WEBPACK_IMPORTED_MODULE_11__["TodayComponent"],
                _components_task_list_task_list_component__WEBPACK_IMPORTED_MODULE_13__["TaskListComponent"],
            ...
            providers: [{ provide: _angular_common__WEBPACK_IMPORTED_MODULE_6__["APP_BASE_HREF"], useValue: '/' }, _services_api_api_service__WEBPACK_IMPORTED_MODULE_15__["ApiService"], _services_auth_authentication_service__WEBPACK_IMPORTED_MODULE_16__["AuthenticationService"], _services_auth_authenticate_service__WEBPACK_IMPORTED_MODULE_17__["AuthenticateService"], _services_today_today_service__WEBPACK_IMPORTED_MODULE_18__["TodayService"]],
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_services_auth_authentication_service__WEBPACK_IMPORTED_MODULE_2__["AuthenticationService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]])
    ], LoginComponent);
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.request = function (method, type, param, user, body) {
        ...
        if (type === 'login' || type === 'signup') {
            ...
            switch (method) {
                case "post":
                    return this.http.post(baseURL + "/api/" + type + "/" + param, body, { headers: jsonMimeType }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
                case 'get':
                    return this.http.get(baseURL + "/api/" + type + "/" + param).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
                case "put":
                    return this.http.put(baseURL + "/api/" + type + "/" + param, body, { headers: jsonMimeType }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
                case "delete":
                    return this.http.delete(baseURL + "/api/" + type + "/" + param).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (res) { return res; }));
                default:
                    break;
            }
        }
